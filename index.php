...
<?php require_once('include/nav.php'); ?>
     ...
     <div class="alert alert-info mb-3">🔖 Website Fake Bill Bản Demo, Đây Là Bản Thử Nên Không Mất Tiền Tạo, Chỉ Cần Ủng Hộ Bằng Cách Click Quảng Cáo Có Trên Webs Là Được :3</div>
            <div class="alert alert-info mb-3">🔖 Được Vận Hành Bởi Trang Chính bởi fb <b style="color:#de0094;">https://www.facebook.com/profile.php?id=100040162778240</b> Mọi Thông Tin Liên Lạc Điều Nằm Ở facebook Này.</div>
  ...
  <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl">
                <div class="footer-container d-flex align-items-center justify-content-between py-3 flex-md-row flex-column">
                  <div class="mb-2 mb-md-0">© <script>document.write(new Date().getFullYear());</script> - From
                    <a href="https://facebook.com/wusthanhdieu" target="_blank" class="footer-link fw-medium"><b>ThanhDieu</b> With Love <span class="text-danger"><i class="tf-icons mdi mdi-heart"></i></span></a>
                  </div>
                </div>
              </div>
            </footer>
  ...
  <div class="modal-dialog" role="document">
   ...
   Anh em nào có thiện chí mua source này về tham khảo hoặc học tập inbox facebook @wusthanhdieu !
  <hr>
      <b style="color:#d40bbc;">
     Nếu thấy hay thì click quảng cáo ủng hộ mình, chỉ mất 5s của các bạn thôi mãi iu <3
</b>
    </div>
      </div>
